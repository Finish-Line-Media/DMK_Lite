...
<section id="media-questions" class="<?php echo esc_attr( $section_class ); ?>" style="background-color: <?php echo esc_attr( $section_color ); ?>">
    <div class="mkp-container">
        <h2 class="mkp-section__title"><?php esc_html_e( 'Questions for the Media', 'mediakit-pro' ); ?></h2>
        <p class="mkp-section__subtitle"><?php esc_html_e( 'Interview questions to help producers prepare', 'mediakit-pro' ); ?></p>
