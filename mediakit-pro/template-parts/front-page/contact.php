...
<section id="contact" class="<?php echo esc_attr( $section_class ); ?>" style="background-color: <?php echo esc_attr( $section_color ); ?>">
    <div class="mkp-container">
        <h2 class="mkp-section__title"><?php esc_html_e( 'Get In Touch', 'mediakit-pro' ); ?></h2>
            ...
            <div class="mkp-contact__info">
                ...
                <?php if ( $primary_email ) : ?>
                    <div class="mkp-contact__item">
                        <h3><?php esc_html_e( 'General Inquiries', 'mediakit-pro' ); ?></h3>
                ...
                <?php if ( $booking_email ) : ?>
                    <div class="mkp-contact__item">
                        <h3><?php esc_html_e( 'Speaking Engagements', 'mediakit-pro' ); ?></h3>
                ...
                <?php if ( $press_email ) : ?>
                    <div class="mkp-contact__item">
                        <h3><?php esc_html_e( 'Press & Media', 'mediakit-pro' ); ?></h3>
                ...
                <?php if ( $phone ) : ?>
                    <div class="mkp-contact__item">
                        <h3><?php esc_html_e( 'Phone', 'mediakit-pro' ); ?></h3>
                ...
                <?php if ( $address ) : ?>
                    <div class="mkp-contact__item">
                        <h3><?php esc_html_e( 'Location', 'mediakit-pro' ); ?></h3>
                        <address>
                ...
                <?php if ( $calendar_link ) : ?>
                    <div class="mkp-contact__item">
                        <a href="<?php echo esc_url( $calendar_link ); ?>" class="mkp-btn mkp-btn--primary" target="_blank" rel="noopener">
                            <?php esc_html_e( 'Schedule a Call', 'mediakit-pro' ); ?>
                        </a>
                    </div>
                <?php endif; ?>
            </div>
