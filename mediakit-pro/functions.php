<?php
/**
 * MediaKit Pro functions and definitions
 *
 ...
 * Define Constants
 */
define( 'MKP_THEME_VERSION', '1.2.1' );
...
function mkp_theme_setup() {
    ...
    register_nav_menus( array(
        'primary' => esc_html__( 'Primary Menu', 'mediakit-pro' ),
        'footer'  => esc_html__( 'Footer Menu', 'mediakit-pro' ),
        'social'  => esc_html__( 'Social Links Menu', 'mediakit-pro' ),
    ) );
...
function mkp_widgets_init() {
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar', 'mediakit-pro' ),
        'id'            => 'sidebar-1',
        'description'   => esc_html__( 'Add widgets here.', 'mediakit-pro' ),
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer 1', 'mediakit-pro' ),
        'id'            => 'footer-1',
        'description'   => esc_html__( 'Footer widget area 1', 'mediakit-pro' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer 2', 'mediakit-pro' ),
        'id'            => 'footer-2',
        'description'   => esc_html__( 'Footer widget area 2', 'mediakit-pro' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h3 class="widget-title">',
        'after_title'   => '</h3>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer 3', 'mediakit-pro' ),
        'id'            => 'footer-3',
        'description'   => esc_html__( 'Footer widget area 3', 'mediakit-pro' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h3 class="widget-title">',
        'after_title'   => '</h3>',
...
function mkp_scripts() {
    ...
    wp_enqueue_style( 'mediakit-pro-style', get_stylesheet_uri(), array(), MKP_THEME_VERSION );
    
    // Enqueue Google Fonts if needed
    wp_enqueue_style( 'mediakit-pro-fonts', 'https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Playfair+Display:wght@400;700&display=swap', array(), null );
    
    // Enqueue main JavaScript
    wp_enqueue_script( 'mediakit-pro-script', MKP_THEME_URI . '/assets/js/main.js', array('jquery'), MKP_THEME_VERSION, true );
    
    // Localize script
    wp_localize_script( 'mediakit-pro-script', 'mkp_ajax', array(
...
foreach ( $required_files as $file ) {
    ...
    if ( file_exists( $file_path ) ) {
        ...
        if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
            error_log( 'MediaKit Pro: Missing required file: ' . $file_path );
        }
    }
}
...
function mkp_add_script_attributes( $tag, $handle ) {
    $scripts_to_defer = array( 'mediakit-pro-script' );
