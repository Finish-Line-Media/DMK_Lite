...
function mkp_dashboard_widget_display() {
    ...
    <div class="mkp-dashboard-widget">
        <h3><?php esc_html_e( 'Welcome to MediaKit Pro', 'mediakit-pro' ); ?></h3>
        <p><?php esc_html_e( 'Your professional media kit theme is ready. Use the Customizer to configure your content.', 'mediakit-pro' ); ?></p>
        
        <h3><?php esc_html_e( 'Quick Actions', 'mediakit-pro' ); ?></h3>
        <div class="mkp-dashboard-actions">
            <a href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Customize Theme', 'mediakit-pro' ); ?></a>
            <a href="<?php echo esc_url( site_url() ); ?>" class="button" target="_blank"><?php esc_html_e( 'View Site', 'mediakit-pro' ); ?></a>
        </div>
    ...
    <div class="wrap">
        ...
        <div class="mkp-admin-page">
            ...
            <div class="mkp-admin-cards">
                ...
                <div class="mkp-admin-card">
                    <h3>2. <?php esc_html_e( 'Configure Sections', 'mediakit-pro' ); ?></h3>
                    <p><?php esc_html_e( 'Set up your bio, books, media items, and more.', 'mediakit-pro' ); ?></p>
                    <a href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>" class="button"><?php esc_html_e( 'Configure Sections', 'mediakit-pro' ); ?></a>
                </div>
                ...
                <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                    ...
                    <p>
                        <label>
                            ...
                            <?php esc_html_e( 'Include Theme Settings', 'mediakit-pro' ); ?>
                        </label>
                    </p>
                    <p>
                        <label>
                            <input type="checkbox" name="export_customizer" value="1" checked>
                            <?php esc_html_e( 'Include Customizer Settings', 'mediakit-pro' ); ?>
                        </label>
                    </p>
                    <p class="submit">
