...
function mkp_block_categories( $categories, $post ) {
    return array_merge(
        ...
        array(
            array(
                'slug'  => 'mediakit-pro',
                'title' => __( 'MediaKit Pro', 'mediakit-pro' ),
...
function mkp_register_blocks() {
    ...
    // Hero Section Block
    register_block_type( 'mediakit-pro/hero-section', array(
        'attributes' => array(
        ...
        'category' => 'mediakit-pro',
    ) );
    
    // Timeline Block
    register_block_type( 'mediakit-pro/timeline', array(
        'attributes' => array(
            'items' => array(
                'type' => 'array',
                'default' => array(),
    ...
    // Stats/Metrics Block
    register_block_type( 'mediakit-pro/stats', array(
        'attributes' => array(
            'stats' => array(
                'type' => 'array',
                'default' => array(),
    ...
    register_block_type( 'mediakit-pro/media-logos', array(
        'attributes' => array(
            'logos' => array(
                'type' => 'array',
                'default' => array(),
    ...
    register_block_type( 'mediakit-pro/video-section', array(
        'attributes' => array(
            'videoUrl' => array(
                'type' => 'string',
                'default' => '',
    ...
    register_block_type( 'mediakit-pro/download-section', array(
        'attributes' => array(
            'title' => array(
                'type' => 'string',
    ...
    <div class="mkp-video-section">
        ...
        <?php if ( ! empty( $attributes['additionalVideos'] ) ) : ?>
            <div class="mkp-video-section__gallery">
                <h4 class="mkp-video-section__gallery-title"><?php esc_html_e( 'More Videos', 'mediakit-pro' ); ?></h4>
...
function mkp_register_block_patterns() {
    register_block_pattern_category(
        'mediakit-pro',
        array( 'label' => __( 'MediaKit Pro', 'mediakit-pro' ) )
    );
    
    // Media Kit Homepage Pattern
    register_block_pattern(
        'mediakit-pro/media-kit-homepage',
        array(
            'title'       => __( 'Media Kit Homepage', 'mediakit-pro' ),
            'description' => __( 'A complete media kit homepage layout', 'mediakit-pro' ),
            'categories'  => array( 'mediakit-pro' ),
            'content'     => '<!-- wp:mediakit-pro/hero-section /-->
<!-- wp:mediakit-pro/stats /-->
<!-- wp:heading {"textAlign":"center"} -->
<h2 class="has-text-align-center">Featured In</h2>
<!-- /wp:heading -->
<!-- wp:mediakit-pro/media-logos /-->
<!-- wp:heading {"textAlign":"center"} -->
...
<!-- /wp:query -->',
    ...
    // Speaker Bio Pattern
    register_block_pattern(
        'mediakit-pro/speaker-bio',
        array(
            'title'       => __( 'Speaker Bio Section', 'mediakit-pro' ),
            'description' => __( 'A professional speaker bio section', 'mediakit-pro' ),
            'categories'  => array( 'mediakit-pro' ),
