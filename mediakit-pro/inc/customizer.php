...
function mkp_customize_register( $wp_customize ) {
    ...
    if ( $wp_customize->get_section( 'title_tagline' ) ) {
        $wp_customize->get_section( 'title_tagline' )->title = __( 'Navigation', 'mediakit-pro' );
        $wp_customize->get_section( 'title_tagline' )->priority = 25;
        $wp_customize->get_section( 'title_tagline' )->description = __( 'Configure your site navigation and choose which sections to display.', 'mediakit-pro' );
    }
    ...
    if ( $wp_customize->get_control( 'site_icon' ) ) {
        ...
        $wp_customize->get_control( 'site_icon' )->description = __( 'The Site Icon is used as a browser and app icon for your site. Icons must be square, and at least 512 × 512 pixels.', 'mediakit-pro' );
    }
    ...
    $wp_customize->add_control( 'mkp_nav_font', array(
        'label'       => __( 'Navigation Font', 'mediakit-pro' ),
        'description' => __( 'Font for navigation menu items.', 'mediakit-pro' ),
        'section'     => 'title_tagline',
        'type'        => 'select',
        'priority'    => 50,
        'choices'     => array(
            'system'    => __( 'System Fonts (Fastest)', 'mediakit-pro' ),
            'inter'     => __( 'Inter (Modern & Clean)', 'mediakit-pro' ),
            'roboto'    => __( 'Roboto (Google Style)', 'mediakit-pro' ),
            'opensans'  => __( 'Open Sans (Friendly)', 'mediakit-pro' ),
            'lato'      => __( 'Lato (Professional)', 'mediakit-pro' ),
            'montserrat' => __( 'Montserrat (Bold & Modern)', 'mediakit-pro' ),
            'poppins'   => __( 'Poppins (Geometric Sans)', 'mediakit-pro' ),
            'raleway'   => __( 'Raleway (Thin & Stylish)', 'mediakit-pro' ),
        ),
    ) );
    ...
    $wp_customize->add_section( 'mkp_brand_settings', array(
        'title'       => __( 'Brand Settings', 'mediakit-pro' ),
        'priority'    => 30,
        'description' => __( 'Customize your brand colors, section backgrounds, and typography to match your professional identity. These settings will be applied throughout your media kit.', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_primary_color', array(
        'label'       => __( 'Primary Color', 'mediakit-pro' ),
        'description' => __( 'Your main brand color. Used for headings, buttons, and key interface elements.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_secondary_color', array(
        'label'       => __( 'Secondary Color', 'mediakit-pro' ),
        'description' => __( 'Supporting color for links, hover states, and secondary buttons. Should complement your primary color.', 'mediakit-pro' ),
        'section'     => 'mkp_brand_settings',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_accent_color', array(
        'label'       => __( 'Hover Color', 'mediakit-pro' ),
        'description' => __( 'Color used for hover states on links, buttons, and interactive elements. Choose a color that provides good contrast.', 'mediakit-pro' ),
        'section'     => 'mkp_brand_settings',
    ...
    $wp_customize->add_control( 'mkp_primary_font', array(
        'label'       => __( 'Primary Font', 'mediakit-pro' ),
        'description' => __( 'Font for body text and general content. System fonts load fastest, while Google fonts offer more personality.', 'mediakit-pro' ),
        'section'     => 'mkp_brand_settings',
        'type'        => 'select',
        'choices'     => array(
            'system'    => __( 'System Fonts (Fastest)', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( 'mkp_heading_font', array(
        'label'       => __( 'Heading Font', 'mediakit-pro' ),
        'description' => __( 'Font for titles and headings. Choose something that reflects your personal brand and stands out.', 'mediakit-pro' ),
        'section'     => 'mkp_brand_settings',
        'type'        => 'select',
        'choices'     => array(
            'system'    => __( 'System Fonts (Fastest)', 'mediakit-pro' ),
            'playfair'  => __( 'Playfair Display (Elegant Serif)', 'mediakit-pro' ),
            'merriweather' => __( 'Merriweather (Readable Serif)', 'mediakit-pro' ),
            'georgia'   => __( 'Georgia (Classic Serif)', 'mediakit-pro' ),
            'poppins'   => __( 'Poppins (Geometric Sans)', 'mediakit-pro' ),
            'raleway'   => __( 'Raleway (Thin & Stylish)', 'mediakit-pro' ),
        ),
    ) );
    ...
    $wp_customize->add_control( new MKP_Reset_Control( $wp_customize, 'mkp_reset_brand_settings', array(
        'label'       => __( 'Reset Brand Settings', 'mediakit-pro' ),
        'section'     => 'mkp_brand_settings',
        'priority'    => 100,
    ) ) );
    ...
    $wp_customize->add_section( 'mkp_background_settings', array(
        'title'       => __( 'Background Settings', 'mediakit-pro' ),
        'priority'    => 32,
        'description' => __( 'Control the overall site background. Use a solid color for a clean look, or add a pattern/image for more visual interest. Background images work best at 1920x1080 pixels or larger.', 'mediakit-pro' ),
    ) );
    ...
    if ( $wp_customize->get_control( 'background_color' ) ) {
        ...
        $wp_customize->get_control( 'background_color' )->description = __( 'Choose a background color for your entire site. This color will show behind all content areas.', 'mediakit-pro' );
    }
    ...
    if ( $wp_customize->get_control( 'background_image' ) ) {
        ...
        $wp_customize->get_control( 'background_image' )->description = __( 'Upload a background image or pattern. For best results, use images at least 1920x1080 pixels. Subtle patterns or blurred images work well.', 'mediakit-pro' );
    }
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_background_overlay_color', array(
        'label'       => __( 'Background Overlay Color', 'mediakit-pro' ),
        'description' => __( 'Color for the overlay on background image.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( 'mkp_background_overlay_opacity', array(
        'label'       => __( 'Background Overlay Opacity', 'mediakit-pro' ),
        'description' => __( 'Opacity of the overlay (0 = transparent, 100 = opaque).', 'mediakit-pro' ),
        'section'     => 'mkp_background_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'min'  => 0,
    ...
    $wp_customize->add_control( new MKP_Reset_Control( $wp_customize, 'mkp_reset_background_settings', array(
        'label'       => __( 'Reset Background Settings', 'mediakit-pro' ),
        'section'     => 'mkp_background_settings',
        'priority'    => 100,
    ) ) );
    ...
    $wp_customize->add_section( 'mkp_hero_section', array(
        'title'       => __( 'Hero Section', 'mediakit-pro' ),
        'priority'    => 35,
        'description' => __( 'Create a powerful first impression with your hero section. This is the first thing visitors see, so make it count with compelling text and visuals.', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mkp_hero_profile_photo', array(
        'label'       => __( 'Profile Photo', 'mediakit-pro' ),
        'description' => __( 'Upload your professional headshot. Image will display at full size with a maximum height of 300px.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( 'mkp_hero_profile_photo_position', array(
        'label'       => __( 'Profile Photo Position', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
        'type'        => 'radio',
        'choices'     => array(
            'left'  => __( 'Left', 'mediakit-pro' ),
            'right' => __( 'Right', 'mediakit-pro' ),
        ),
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mkp_hero_family_crest', array(
        'label'       => __( 'Family Crest', 'mediakit-pro' ),
        'description' => __( 'Upload your family crest or logo. Image will display at full size with a maximum height of 300px.', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
    ...
    $wp_customize->add_control( 'mkp_hero_family_crest_position', array(
        'label'       => __( 'Family Crest Position', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
        'type'        => 'radio',
        'choices'     => array(
            'left'  => __( 'Left', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_hero_background_color', array(
        'label'       => __( 'Hero Background Color', 'mediakit-pro' ),
        'description' => __( 'Background color for the hero section.', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mkp_hero_background', array(
        'label'       => __( 'Hero Background Image (Optional)', 'mediakit-pro' ),
        'description' => __( 'Optional background image (1920x1080 or larger). Leave empty for clean section color background.', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
    ...
    $wp_customize->add_control( 'mkp_hero_video', array(
        'label'       => __( 'Hero Background Video URL', 'mediakit-pro' ),
        'description' => __( 'Optional: Add a YouTube/Vimeo URL for dynamic backgrounds. Keep videos under 30 seconds and ensure they have captions for accessibility.', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
        'type'        => 'url',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_hero_overlay_color', array(
        'label'       => __( 'Hero Overlay Color', 'mediakit-pro' ),
        'description' => __( 'Color for the overlay on hero background image.', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
    ...
    $wp_customize->add_control( 'mkp_hero_overlay_opacity', array(
        'label'       => __( 'Hero Overlay Opacity', 'mediakit-pro' ),
        'description' => __( 'Opacity of the overlay (0 = transparent, 100 = opaque).', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
        'type'        => 'range',
        'input_attrs' => array(
    ...
    $wp_customize->add_setting( 'mkp_hero_name', array(
        'default'           => __( 'Your Name', 'mediakit-pro' ),
        'sanitize_callback' => 'wp_kses_post',
        'transport'         => 'postMessage',
    ) );
    
    $wp_customize->add_control( 'mkp_hero_name', array(
        'label'       => __( 'Person\'s Name', 'mediakit-pro' ),
        'description' => __( 'Your full name as you want it displayed prominently.', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
        'type'        => 'text',
    ) );
    ...
    for ( $i = 1; $i <= 5; $i++ ) {
        ...
        $wp_customize->add_control( 'mkp_hero_tag_' . $i, array(
            'label'       => sprintf( __( 'Professional Tag %d', 'mediakit-pro' ), $i ),
            'description' => $i === 1 ? __( 'Add up to 5 professional tags (e.g., Podcaster, Investor, Speaker, Author, Entrepreneur)', 'mediakit-pro' ) : '',
            'section'     => 'mkp_hero_section',
            'type'        => 'text',
        ) );
    }
    ...
    $wp_customize->add_setting( 'mkp_hero_cta1_text', array(
        'default'           => __( 'Book Me', 'mediakit-pro' ),
        'sanitize_callback' => 'sanitize_text_field',
    ) );
    
    $wp_customize->add_control( 'mkp_hero_cta1_text', array(
        'label'       => __( 'Primary Button Text', 'mediakit-pro' ),
        'description' => __( 'Your main call-to-action. Common options: "Book Me", "Get In Touch", "Schedule a Call", "Learn More"', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
        'type'        => 'text',
    ) );
    ...
    $wp_customize->add_control( 'mkp_hero_cta1_url', array(
        'label'       => __( 'Primary Button URL', 'mediakit-pro' ),
        'description' => __( 'Where the button links to. Use #contact for contact section, or add external booking link.', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
        'type'        => 'url',
    ) );
    ...
    $wp_customize->add_setting( 'mkp_hero_cta2_text', array(
        'default'           => __( 'Download Media Kit', 'mediakit-pro' ),
        'sanitize_callback' => 'sanitize_text_field',
    ) );
    
    $wp_customize->add_control( 'mkp_hero_cta2_text', array(
        'label'       => __( 'Secondary Button Text', 'mediakit-pro' ),
        'description' => __( 'Optional second action. Examples: "Download Media Kit", "View Speaking Topics", "Watch Demo Reel"', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
        'type'        => 'text',
    ) );
    ...
    $wp_customize->add_control( 'mkp_hero_cta2_url', array(
        'label'       => __( 'Secondary Button URL', 'mediakit-pro' ),
        'description' => __( 'Link for the secondary button. Can be a page, download link, or external URL.', 'mediakit-pro' ),
        'section'     => 'mkp_hero_section',
        'type'        => 'url',
    ) );
    ...
    $wp_customize->add_section( 'mkp_social_media', array(
        'title'       => __( 'Social Media', 'mediakit-pro' ),
        'priority'    => 40,
        'description' => __( 'Connect your social media profiles. Only filled URLs will display. Icons will appear in your header, footer, and contact sections.', 'mediakit-pro' ),
    ) );
    
    // Social Media Platforms
    $social_platforms = array(
        'facebook'  => array( 'label' => __( 'Facebook', 'mediakit-pro' ), 'desc' => __( 'Your Facebook page or profile URL', 'mediakit-pro' ) ),
        'twitter'   => array( 'label' => __( 'X (Twitter)', 'mediakit-pro' ), 'desc' => __( 'Your X profile URL (formerly Twitter)', 'mediakit-pro' ) ),
        'instagram' => array( 'label' => __( 'Instagram', 'mediakit-pro' ), 'desc' => __( 'Your Instagram profile URL', 'mediakit-pro' ) ),
        'linkedin'  => array( 'label' => __( 'LinkedIn', 'mediakit-pro' ), 'desc' => __( 'Your LinkedIn profile URL (important for professional connections)', 'mediakit-pro' ) ),
        'youtube'   => array( 'label' => __( 'YouTube', 'mediakit-pro' ), 'desc' => __( 'Your YouTube channel URL', 'mediakit-pro' ) ),
        'tiktok'    => array( 'label' => __( 'TikTok', 'mediakit-pro' ), 'desc' => __( 'Your TikTok profile URL', 'mediakit-pro' ) ),
    );
    ...
    foreach ( $social_platforms as $platform => $info ) {
        ...
        $wp_customize->add_control( 'mkp_social_' . $platform, array(
            'label'       => $info['label'] . ' ' . __( 'URL', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( 'mkp_social_icon_style', array(
        'label'       => __( 'Social Icon Style', 'mediakit-pro' ),
        'description' => __( 'Choose how your social media icons appear throughout the site.', 'mediakit-pro' ),
        'section'     => 'mkp_social_media',
        'type'        => 'select',
        'choices'     => array(
            'circle'   => __( 'Circle (Modern & friendly)', 'mediakit-pro' ),
            'square'   => __( 'Square (Bold & structured)', 'mediakit-pro' ),
            'rounded'  => __( 'Rounded Square (Soft & approachable)', 'mediakit-pro' ),
            'minimal'  => __( 'Minimal (Clean & simple)', 'mediakit-pro' ),
        ),
    ) );
    ...
    $wp_customize->add_section( 'mkp_bio_section', array(
        'title'       => __( 'About/Bio Section', 'mediakit-pro' ),
        'priority'    => 41,
        'description' => __( 'Share your story and background. Keep it concise and impactful (3-5 paragraphs maximum).', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_bio_background_color', array(
        'label'       => __( 'Background Color', 'mediakit-pro' ),
        'description' => __( 'Background color for the bio section.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( 'mkp_bio_content', array(
        'label'       => __( 'Biography Content', 'mediakit-pro' ),
        'description' => __( 'Write your professional biography. Use paragraphs separated by blank lines. Maximum 3-5 paragraphs for optimal readability.', 'mediakit-pro' ),
        'section'     => 'mkp_bio_section',
        'type'        => 'textarea',
    ) );
    ...
    $wp_customize->add_section( 'mkp_books_section', array(
        'title'       => __( 'Books', 'mediakit-pro' ),
        'priority'    => 42,
        'description' => __( 'Showcase your published books or upcoming releases.', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( 'mkp_enable_section_books', array(
        'label'       => __( 'Enable Books Section', 'mediakit-pro' ),
        'description' => __( 'Show or hide the books section on your landing page.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_books_background_color', array(
        'label'       => __( 'Background Color', 'mediakit-pro' ),
        'description' => __( 'Background color for the books section.', 'mediakit-pro' ),
        'section'     => 'mkp_books_section',
    ...
    $wp_customize->add_control( 'mkp_books_count', array(
        'label'       => __( 'Number of Books', 'mediakit-pro' ),
        'description' => __( 'How many books do you want to display? (1-6)', 'mediakit-pro' ),
        'section'     => 'mkp_books_section',
        'type'        => 'number',
        'input_attrs' => array(
            'min'  => 1,
    ...
    for ( $i = 1; $i <= 6; $i++ ) {
        ...
        $wp_customize->add_control( 'mkp_book_' . $i . '_title', array(
            'label'       => sprintf( __( 'Book %d Title', 'mediakit-pro' ), $i ),
            'section'     => 'mkp_books_section',
            'type'        => 'text',
        ) );
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mkp_book_' . $i . '_cover', array(
            'label'       => sprintf( __( 'Book %d Cover Image', 'mediakit-pro' ), $i ),
            'section'     => 'mkp_books_section',
        ...
        $wp_customize->add_control( 'mkp_book_' . $i . '_description', array(
            'label'       => sprintf( __( 'Book %d Description', 'mediakit-pro' ), $i ),
            'description' => __( 'Brief description. For unpublished books, use "Highly Anticipated Book due out this fall" or similar.', 'mediakit-pro' ),
            'section'     => 'mkp_books_section',
            'type'        => 'textarea',
        ) );
        ...
        $wp_customize->add_control( 'mkp_book_' . $i . '_link', array(
            'label'       => sprintf( __( 'Book %d Purchase Link', 'mediakit-pro' ), $i ),
            'section'     => 'mkp_books_section',
            'type'        => 'url',
        ) );
    }
    ...
    $wp_customize->add_section( 'mkp_speaker_section', array(
        'title'       => __( 'Speaker Topics', 'mediakit-pro' ),
        'priority'    => 43,
        'description' => __( 'List 5 themes/topics you are qualified to speak on.', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( 'mkp_enable_section_speaker_topics', array(
        'label'       => __( 'Enable Speaker Topics Section', 'mediakit-pro' ),
        'description' => __( 'Show or hide the speaker topics section on your landing page.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_speaker_topics_background_color', array(
        'label'       => __( 'Background Color', 'mediakit-pro' ),
        'description' => __( 'Background color for the speaker topics section.', 'mediakit-pro' ),
        'section'     => 'mkp_speaker_section',
    ...
    for ( $i = 1; $i <= 5; $i++ ) {
        ...
        $wp_customize->add_control( 'mkp_speaker_topic_' . $i, array(
            'label'       => sprintf( __( 'Speaking Topic %d', 'mediakit-pro' ), $i ),
            'description' => $i === 1 ? __( 'Enter a topic you speak about professionally', 'mediakit-pro' ) : '',
            'section'     => 'mkp_speaker_section',
            'type'        => 'text',
        ) );
    }
    ...
    $wp_customize->add_section( 'mkp_podcast_section', array(
        'title'       => __( 'Podcast/Show', 'mediakit-pro' ),
        'priority'    => 44,
        'description' => __( 'Information about your podcast or show.', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( 'mkp_enable_section_podcast', array(
        'label'       => __( 'Enable Podcast/Show Section', 'mediakit-pro' ),
        'description' => __( 'Show or hide the podcast/show section on your landing page.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_podcast_background_color', array(
        'label'       => __( 'Background Color', 'mediakit-pro' ),
        'description' => __( 'Background color for the podcast/show section.', 'mediakit-pro' ),
        'section'     => 'mkp_podcast_section',
    ...
    $wp_customize->add_control( 'mkp_podcast_name', array(
        'label'       => __( 'Podcast/Show Name', 'mediakit-pro' ),
        'section'     => 'mkp_podcast_section',
        'type'        => 'text',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mkp_podcast_logo', array(
        'label'       => __( 'Podcast/Show Logo', 'mediakit-pro' ),
        'description' => __( 'Square logo works best (minimum 500x500 pixels)', 'mediakit-pro' ),
        'section'     => 'mkp_podcast_section',
    ...
    $wp_customize->add_control( 'mkp_podcast_synopsis', array(
        'label'       => __( 'Podcast/Show Synopsis', 'mediakit-pro' ),
        'description' => __( 'Brief description of your podcast or show', 'mediakit-pro' ),
        'section'     => 'mkp_podcast_section',
        'type'        => 'textarea',
    ) );
    ...
    $wp_customize->add_control( 'mkp_podcast_link', array(
        'label'       => __( 'Podcast/Show Website', 'mediakit-pro' ),
        'section'     => 'mkp_podcast_section',
        'type'        => 'url',
    ) );
    ...
    $wp_customize->add_section( 'mkp_corporations_section', array(
        'title'       => __( 'Corporations', 'mediakit-pro' ),
        'priority'    => 45,
        'description' => __( 'Companies or organizations you own or are affiliated with.', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( 'mkp_enable_section_corporations', array(
        'label'       => __( 'Enable Corporations Section', 'mediakit-pro' ),
        'description' => __( 'Show or hide the corporations section on your landing page.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_corporations_background_color', array(
        'label'       => __( 'Background Color', 'mediakit-pro' ),
        'description' => __( 'Background color for the corporations section.', 'mediakit-pro' ),
        'section'     => 'mkp_corporations_section',
    ...
    $wp_customize->add_control( 'mkp_corporations_count', array(
        'label'       => __( 'Number of Corporations', 'mediakit-pro' ),
        'description' => __( 'How many corporations to display? (1-4)', 'mediakit-pro' ),
        'section'     => 'mkp_corporations_section',
        'type'        => 'number',
        'input_attrs' => array(
            'min'  => 1,
    ...
    for ( $i = 1; $i <= 4; $i++ ) {
        ...
        $wp_customize->add_control( 'mkp_corp_' . $i . '_name', array(
            'label'       => sprintf( __( 'Corporation %d Name', 'mediakit-pro' ), $i ),
            'section'     => 'mkp_corporations_section',
            'type'        => 'text',
        ) );
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mkp_corp_' . $i . '_logo', array(
            'label'       => sprintf( __( 'Corporation %d Logo', 'mediakit-pro' ), $i ),
            'section'     => 'mkp_corporations_section',
        ...
        $wp_customize->add_control( 'mkp_corp_' . $i . '_bio', array(
            'label'       => sprintf( __( 'Corporation %d Bio/Synopsis', 'mediakit-pro' ), $i ),
            'section'     => 'mkp_corporations_section',
            'type'        => 'textarea',
        ) );
        ...
        $wp_customize->add_control( 'mkp_corp_' . $i . '_link', array(
            'label'       => sprintf( __( 'Corporation %d Website', 'mediakit-pro' ), $i ),
            'section'     => 'mkp_corporations_section',
            'type'        => 'url',
        ) );
    }
    ...
    $wp_customize->add_section( 'mkp_media_questions_section', array(
        'title'       => __( 'Questions for the Media', 'mediakit-pro' ),
        'priority'    => 46,
        'description' => __( 'Provide 10-12 interview questions to help producers prepare. This does their job for them!', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( 'mkp_enable_section_media_questions', array(
        'label'       => __( 'Enable Media Questions Section', 'mediakit-pro' ),
        'description' => __( 'Show or hide the media questions section on your landing page.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_media_questions_background_color', array(
        'label'       => __( 'Background Color', 'mediakit-pro' ),
        'description' => __( 'Background color for the media questions section.', 'mediakit-pro' ),
        'section'     => 'mkp_media_questions_section',
    ...
    for ( $i = 1; $i <= 12; $i++ ) {
        ...
        $wp_customize->add_control( 'mkp_media_question_' . $i, array(
            'label'       => sprintf( __( 'Question %d', 'mediakit-pro' ), $i ),
            'description' => $i === 1 ? __( 'Provide engaging questions that showcase your expertise', 'mediakit-pro' ) : '',
            'section'     => 'mkp_media_questions_section',
            'type'        => 'text',
        ) );
    }
    ...
    $wp_customize->add_section( 'mkp_investor_section', array(
        'title'       => __( 'Investor', 'mediakit-pro' ),
        'priority'    => 47,
        'description' => __( 'Describe your investment focus and philosophy.', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( 'mkp_enable_section_investor', array(
        'label'       => __( 'Enable Investor Section', 'mediakit-pro' ),
        'description' => __( 'Show or hide the investor section on your landing page.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_investor_background_color', array(
        'label'       => __( 'Background Color', 'mediakit-pro' ),
        'description' => __( 'Background color for the investor section.', 'mediakit-pro' ),
        'section'     => 'mkp_investor_section',
    ...
    $investment_lanes = array(
        'people' => __( 'People', 'mediakit-pro' ),
        'products' => __( 'Products', 'mediakit-pro' ),
        'markets' => __( 'Markets', 'mediakit-pro' ),
    );
    ...
    foreach ( $investment_lanes as $key => $label ) {
        ...
        $wp_customize->add_control( 'mkp_investment_' . $key, array(
            'label'       => sprintf( __( 'Investment in %s', 'mediakit-pro' ), $label ),
            'description' => sprintf( __( 'Describe your investment approach for %s', 'mediakit-pro' ), strtolower( $label ) ),
            'section'     => 'mkp_investor_section',
            'type'        => 'textarea',
        ) );
    }
    ...
    $wp_customize->add_section( 'mkp_in_media_section', array(
        'title'       => __( 'In The Media', 'mediakit-pro' ),
        'priority'    => 48,
        'description' => __( 'Showcase your media appearances, podcasts, and audio samples.', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( 'mkp_enable_section_in_the_media', array(
        'label'       => __( 'Enable In The Media Section', 'mediakit-pro' ),
        'description' => __( 'Show or hide the in the media section on your landing page.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_in_media_background_color', array(
        'label'       => __( 'Background Color', 'mediakit-pro' ),
        'description' => __( 'Background color for the in the media section.', 'mediakit-pro' ),
        'section'     => 'mkp_in_media_section',
    ...
    $wp_customize->add_control( 'mkp_media_items_count', array(
        'label'       => __( 'Number of Media Items', 'mediakit-pro' ),
        'description' => __( 'How many media appearances to display? (1-12)', 'mediakit-pro' ),
        'section'     => 'mkp_in_media_section',
        'type'        => 'number',
        'input_attrs' => array(
            'min'  => 1,
    ...
    for ( $i = 1; $i <= 12; $i++ ) {
        ...
        $wp_customize->add_control( 'mkp_media_item_' . $i . '_title', array(
            'label'       => sprintf( __( 'Media Item %d Title', 'mediakit-pro' ), $i ),
            'section'     => 'mkp_in_media_section',
            'type'        => 'text',
        ) );
        ...
        $wp_customize->add_control( 'mkp_media_item_' . $i . '_type', array(
            'label'       => sprintf( __( 'Media Item %d Type', 'mediakit-pro' ), $i ),
            'section'     => 'mkp_in_media_section',
            'type'        => 'select',
            'choices'     => array(
                'podcast' => __( 'Podcast', 'mediakit-pro' ),
                'interview' => __( 'Interview', 'mediakit-pro' ),
                'audio' => __( 'Audio Sample', 'mediakit-pro' ),
                'video' => __( 'Video', 'mediakit-pro' ),
                'article' => __( 'Article', 'mediakit-pro' ),
            ),
        ) );
        ...
        $wp_customize->add_control( 'mkp_media_item_' . $i . '_link', array(
            'label'       => sprintf( __( 'Media Item %d Link', 'mediakit-pro' ), $i ),
            'section'     => 'mkp_in_media_section',
            'type'        => 'url',
        ) );
    }
    ...
    $wp_customize->add_section( 'mkp_contact_info', array(
        'title'       => __( 'Contact Information', 'mediakit-pro' ),
        'priority'    => 55,
        'description' => __( 'Provide multiple ways for people to reach you. Consider having separate emails for different purposes (general inquiries, bookings, press).', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( 'mkp_enable_section_contact', array(
        'label'       => __( 'Enable Contact Section', 'mediakit-pro' ),
        'description' => __( 'Show or hide the contact section on your landing page.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'mkp_contact_background_color', array(
        'label'       => __( 'Background Color', 'mediakit-pro' ),
        'description' => __( 'Background color for the contact section.', 'mediakit-pro' ),
        'section'     => 'mkp_contact_info',
    ...
    $wp_customize->add_control( 'mkp_contact_email_primary', array(
        'label'       => __( 'Primary Email', 'mediakit-pro' ),
        'description' => __( 'Your main contact email for general inquiries. This will be displayed prominently.', 'mediakit-pro' ),
        'section'     => 'mkp_contact_info',
        'type'        => 'email',
    ) );
    ...
    $wp_customize->add_control( 'mkp_contact_email_booking', array(
        'label'       => __( 'Booking Email', 'mediakit-pro' ),
        'description' => __( 'Dedicated email for speaking engagements and bookings. Can be the same as primary or a booking agent\'s email.', 'mediakit-pro' ),
        'section'     => 'mkp_contact_info',
        'type'        => 'email',
    ) );
    ...
    $wp_customize->add_control( 'mkp_contact_email_press', array(
        'label'       => __( 'Press/Media Email', 'mediakit-pro' ),
        'description' => __( 'Email for media inquiries, interview requests, and press kit requests. Can be same as primary or PR team email.', 'mediakit-pro' ),
        'section'     => 'mkp_contact_info',
        'type'        => 'email',
    ) );
    ...
    $wp_customize->add_control( 'mkp_contact_phone', array(
        'label'       => __( 'Phone Number', 'mediakit-pro' ),
        'description' => __( 'Optional: Include country code for international reach (e.g., +1-555-123-4567). Consider if you want this public.', 'mediakit-pro' ),
        'section'     => 'mkp_contact_info',
        'type'        => 'tel',
    ) );
    ...
    $wp_customize->add_control( 'mkp_contact_address', array(
        'label'       => __( 'Address', 'mediakit-pro' ),
        'description' => __( 'Optional: Your business address or city/country for location reference. You can be as specific or general as you prefer.', 'mediakit-pro' ),
        'section'     => 'mkp_contact_info',
        'type'        => 'textarea',
    ) );
    ...
    $wp_customize->add_control( 'mkp_booking_calendar_link', array(
        'label'       => __( 'Booking Calendar Link', 'mediakit-pro' ),
        'description' => __( 'Direct link to your online scheduling tool (Calendly, Acuity, etc.). This enables instant booking for discovery calls or consultations.', 'mediakit-pro' ),
        'section'     => 'mkp_contact_info',
        'type'        => 'url',
    ) );
    ...
    $wp_customize->add_section( 'mkp_seo_settings', array(
        'title'       => __( 'SEO Settings', 'mediakit-pro' ),
        'priority'    => 60,
        'description' => __( 'Optimize how your media kit appears in search engines and social media. These settings help you get discovered by event planners and media professionals.', 'mediakit-pro' ),
    ) );
    ...
    $wp_customize->add_control( 'mkp_default_meta_description', array(
        'label'       => __( 'Default Meta Description', 'mediakit-pro' ),
        'description' => __( 'A compelling 150-160 character description of who you are and what you offer. This appears in search results. Include keywords like "keynote speaker" or your expertise area.', 'mediakit-pro' ),
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mkp_default_social_image', array(
        'label'       => __( 'Default Social Media Image', 'mediakit-pro' ),
        'description' => __( 'Image shown when your site is shared on social media. Use a professional photo or branded image at 1200x630 pixels for best results across all platforms.', 'mediakit-pro' ),
        'section'     => 'mkp_seo_settings',
    ...
    $wp_customize->add_control( 'mkp_enable_schema', array(
        'label'       => __( 'Enable Schema Markup', 'mediakit-pro' ),
        'description' => __( 'Adds structured data to help search engines understand your content better. This can lead to rich snippets in search results. Recommended to leave enabled.', 'mediakit-pro' ),
        'section'     => 'mkp_seo_settings',
        'type'        => 'checkbox',
    ) );
}
...
function mkp_customize_controls_js() {
    ...
    wp_localize_script( 'mkp-customizer-controls', 'mkpCustomizer', array(
        'confirmReset' => __( 'Are you sure you want to reset all settings in this section to their defaults?', 'mediakit-pro' ),
    ) );
}
    ...
    class MKP_Reset_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            <button type="button" class="button mkp-reset-section" data-section="<?php echo esc_attr( $this->section ); ?>">
                <?php esc_html_e( 'Reset Section to Defaults', 'mediakit-pro' ); ?>
            </button>
            <?php
        }
    }
