...
$duration_labels = array(
    '30min' => __( '30 minutes', 'mediakit-lite' ),
    '45min' => __( '45 minutes', 'mediakit-lite' ),
    '60min' => __( '60 minutes', 'mediakit-lite' ),
    '90min' => __( '90 minutes', 'mediakit-lite' ),
    'half-day' => __( 'Half Day Workshop', 'mediakit-lite' ),
    'full-day' => __( 'Full Day Workshop', 'mediakit-lite' ),
);
?>
    ...
    <div class="mkp-speaker-topic__content">
        ...
        <div class="mkp-speaker-topic__meta">
            <?php if ( $target_audience ) : ?>
                <div class="mkp-speaker-topic__audience">
                    <strong><?php esc_html_e( 'Audience:', 'mediakit-lite' ); ?></strong>
            ...
            <?php if ( $duration && isset( $duration_labels[ $duration ] ) ) : ?>
                <div class="mkp-speaker-topic__duration">
                    <strong><?php esc_html_e( 'Duration:', 'mediakit-lite' ); ?></strong>
        ...
        <?php if ( ! empty( $key_takeaways ) ) : ?>
            <div class="mkp-speaker-topic__takeaways">
                <h4><?php esc_html_e( 'Key Takeaways:', 'mediakit-lite' ); ?></h4>
                <ul>
        ...
        <a href="<?php the_permalink(); ?>" class="mkp-btn mkp-btn--text">
            <?php esc_html_e( 'Learn More', 'mediakit-lite' ); ?> &rarr;
        </a>
    </div>
</article>