...
<section id="media-questions" class="<?php echo esc_attr( $section_class ); ?> mkp-media-questions-section--<?php echo esc_attr( $list_style ); ?>" style="background-color: <?php echo esc_attr( $section_color ); ?>">
    <div class="mkp-container">
        ...
        <<?php echo $tag; ?> class="<?php echo esc_attr( $list_class ); ?>">
            <?php for ( $i = 1; $i <= 12; $i++ ) : 
                ...
                ?>
                <li class="mkp-media-questions__item mkp-media-questions__item--<?php echo esc_attr( $i ); ?><?php echo $list_style === 'arrows' ? ' mkp-media-questions__item--arrows' : ''; ?>">
