...
<section id="investor" class="<?php echo esc_attr( $section_class ); ?>" style="background-color: <?php echo esc_attr( $section_color ); ?>">
    <div class="mkp-container">
        <h2 class="mkp-section__title"><?php esc_html_e( 'Investment Focus', 'mediakit-lite' ); ?></h2>
        
        <div class="mkp-investor__lanes">
            <?php if ( $investment_people ) : ?>
                <div class="mkp-investor__lane">
                    <h3 class="mkp-investor__lane-title"><?php esc_html_e( 'People', 'mediakit-lite' ); ?></h3>
            ...
            <?php if ( $investment_products ) : ?>
                <div class="mkp-investor__lane">
                    <h3 class="mkp-investor__lane-title"><?php esc_html_e( 'Products', 'mediakit-lite' ); ?></h3>
                    <div class="mkp-investor__lane-content">
            ...
            <?php if ( $investment_markets ) : ?>
                <div class="mkp-investor__lane">
                    <h3 class="mkp-investor__lane-title"><?php esc_html_e( 'Markets', 'mediakit-lite' ); ?></h3>
                    <div class="mkp-investor__lane-content">
