<?php
/**
 * Custom Social Media Control for Customizer
 *
...
/**
 * Custom control for social media with icon preview
 */
if ( class_exists( 'WP_Customize_Control' ) ) {
    
class MKP_Social_Media_Control extends WP_Customize_Control {
    
    public $type = 'mkp_social_media';
    public $platform_data = array();
    ...
    public function enqueue() {
        wp_enqueue_style( 
            'mkp-social-media-control', 
            get_template_directory_uri() . '/assets/css/social-media-control.css', 
            array(), 
            MKP_THEME_VERSION 
        );
    }
    ...
    public function render_content() {
        ?>
        <div class="mkp-social-control">
            <?php if ( ! empty( $this->label ) ) : ?>
                <span class="customize-control-title">
                    <span class="mkp-social-icon" data-platform="<?php echo esc_attr( $this->id ); ?>">
    ...
    private function get_placeholder() {
        if ( ! empty( $this->platform_data['prefix'] ) ) {
            return str_replace( 'https://', '', $this->platform_data['prefix'] ) . 'username';
        }
        return '@username';
    }
    
    /**
     * Render the platform icon
     */
    private function render_icon() {
        $platform = str_replace( 'mkp_social_', '', $this->id );
        $svg_icons = array(
