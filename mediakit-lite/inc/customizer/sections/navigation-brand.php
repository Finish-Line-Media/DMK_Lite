...
function mkp_register_navigation_brand_section( $wp_customize ) {
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mkp_social_share_image', array(
        ...
        'description' => __( 'Image shown when your site is shared on LinkedIn, Facebook, WhatsApp, etc. Must be at least 1200 × 630 pixels and under 300KB for best results.', 'mediakit-lite' ),
        'section'     => 'title_tagline',
        'priority'    => 15,
    ) ) );
