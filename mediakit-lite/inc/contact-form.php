...
function mkp_contact_form_shortcode( $atts ) {
    $atts = shortcode_atts( array(
        ...
        'subject' => '',
        'button_text' => __( 'Send Message', 'mediakit-lite' ),
        'success_message' => __( 'Thank you for your message. We\'ll get back to you soon!', 'mediakit-lite' ),
    ), $atts );
    ...
    <div class="mkp-contact-form-wrapper">
        <form id="<?php echo esc_attr( $form_id ); ?>" class="mkp-contact-form" method="post" novalidate>
            ...
            <?php if ( $args['type'] === 'booking' ) : ?>
                ...
                <div class="mkp-form-row">
                    <div class="mkp-form-group mkp-form-half">
                        <label for="<?php echo $form_id; ?>-name"><?php esc_html_e( 'Name', 'mediakit-lite' ); ?> <span class="required">*</span></label>
                        <input type="text" id="<?php echo $form_id; ?>-name" name="mkp_name" required>
                    </div>
                    
                    <div class="mkp-form-group mkp-form-half">
                        <label for="<?php echo $form_id; ?>-email"><?php esc_html_e( 'Email', 'mediakit-lite' ); ?> <span class="required">*</span></label>
                ...
                <div class="mkp-form-row">
                    <div class="mkp-form-group mkp-form-half">
                        <label for="<?php echo $form_id; ?>-organization"><?php esc_html_e( 'Organization', 'mediakit-lite' ); ?> <span class="required">*</span></label>
                        <input type="text" id="<?php echo $form_id; ?>-organization" name="mkp_organization" required>
                    </div>
                    
                    <div class="mkp-form-group mkp-form-half">
                        <label for="<?php echo $form_id; ?>-phone"><?php esc_html_e( 'Phone', 'mediakit-lite' ); ?></label>
                ...
                <div class="mkp-form-row">
                    <div class="mkp-form-group mkp-form-half">
                        <label for="<?php echo $form_id; ?>-event-date"><?php esc_html_e( 'Event Date', 'mediakit-lite' ); ?> <span class="required">*</span></label>
                        <input type="date" id="<?php echo $form_id; ?>-event-date" name="mkp_event_date" required>
                    </div>
                    
                    <div class="mkp-form-group mkp-form-half">
                        <label for="<?php echo $form_id; ?>-event-type"><?php esc_html_e( 'Event Type', 'mediakit-lite' ); ?> <span class="required">*</span></label>
                        <select id="<?php echo $form_id; ?>-event-type" name="mkp_event_type" required>
                            <option value=""><?php esc_html_e( 'Select Event Type', 'mediakit-lite' ); ?></option>
                            <option value="conference"><?php esc_html_e( 'Conference', 'mediakit-lite' ); ?></option>
                            <option value="workshop"><?php esc_html_e( 'Workshop', 'mediakit-lite' ); ?></option>
                            <option value="keynote"><?php esc_html_e( 'Keynote', 'mediakit-lite' ); ?></option>
                            <option value="panel"><?php esc_html_e( 'Panel Discussion', 'mediakit-lite' ); ?></option>
                            <option value="webinar"><?php esc_html_e( 'Webinar', 'mediakit-lite' ); ?></option>
                            <option value="other"><?php esc_html_e( 'Other', 'mediakit-lite' ); ?></option>
                        </select>
                    </div>
                </div>
                
                <div class="mkp-form-group">
                    <label for="<?php echo $form_id; ?>-location"><?php esc_html_e( 'Event Location', 'mediakit-lite' ); ?></label>
                    <input type="text" id="<?php echo $form_id; ?>-location" name="mkp_location" placeholder="<?php esc_attr_e( 'City, State/Country or Virtual', 'mediakit-lite' ); ?>">
                </div>
                
                <div class="mkp-form-group">
                    <label for="<?php echo $form_id; ?>-message"><?php esc_html_e( 'Event Details & Requirements', 'mediakit-lite' ); ?> <span class="required">*</span></label>
            ...
            <?php elseif ( $args['type'] === 'media' ) : ?>
                ...
                <div class="mkp-form-row">
                    <div class="mkp-form-group mkp-form-half">
                        <label for="<?php echo $form_id; ?>-outlet"><?php esc_html_e( 'Media Outlet', 'mediakit-lite' ); ?> <span class="required">*</span></label>
                        <input type="text" id="<?php echo $form_id; ?>-outlet" name="mkp_media_outlet" required>
                    </div>
                    
                    <div class="mkp-form-group mkp-form-half">
                        <label for="<?php echo $form_id; ?>-deadline"><?php esc_html_e( 'Deadline', 'mediakit-lite' ); ?></label>
                        <input type="date" id="<?php echo $form_id; ?>-deadline" name="mkp_deadline">
                    </div>
                </div>
                
                <div class="mkp-form-group">
                    <label for="<?php echo $form_id; ?>-inquiry-type"><?php esc_html_e( 'Type of Inquiry', 'mediakit-lite' ); ?> <span class="required">*</span></label>
                    <select id="<?php echo $form_id; ?>-inquiry-type" name="mkp_inquiry_type" required>
                        <option value=""><?php esc_html_e( 'Select Inquiry Type', 'mediakit-lite' ); ?></option>
                        <option value="interview"><?php esc_html_e( 'Interview Request', 'mediakit-lite' ); ?></option>
                        <option value="quote"><?php esc_html_e( 'Expert Quote', 'mediakit-lite' ); ?></option>
                        <option value="article"><?php esc_html_e( 'Article Contribution', 'mediakit-lite' ); ?></option>
                        <option value="podcast"><?php esc_html_e( 'Podcast Appearance', 'mediakit-lite' ); ?></option>
                        <option value="tv"><?php esc_html_e( 'TV/Video Appearance', 'mediakit-lite' ); ?></option>
                        <option value="other"><?php esc_html_e( 'Other', 'mediakit-lite' ); ?></option>
                    </select>
                </div>
                
                <div class="mkp-form-group">
                    <label for="<?php echo $form_id; ?>-message"><?php esc_html_e( 'Details of Your Request', 'mediakit-lite' ); ?> <span class="required">*</span></label>
                    <textarea id="<?php echo $form_id; ?>-message" name="mkp_message" rows="5" required></textarea>
                </div>
            ...
            <?php else : ?>
                ...
                <div class="mkp-form-group">
                    <label for="<?php echo $form_id; ?>-subject"><?php esc_html_e( 'Subject', 'mediakit-lite' ); ?> <span class="required">*</span></label>
                    <input type="text" id="<?php echo $form_id; ?>-subject" name="mkp_subject" required>
                </div>
                
                <div class="mkp-form-group">
                    <label for="<?php echo $form_id; ?>-message"><?php esc_html_e( 'Message', 'mediakit-lite' ); ?> <span class="required">*</span></label>
                    <textarea id="<?php echo $form_id; ?>-message" name="mkp_message" rows="5" required></textarea>
                </div>
            <?php endif; ?>
            ...
            <div class="mkp-honeypot" aria-hidden="true">
                <label for="<?php echo $form_id; ?>-website"><?php esc_html_e( 'Website', 'mediakit-lite' ); ?></label>
            ...
            <div class="mkp-form-group">
                <button type="submit" class="mkp-btn mkp-btn--primary mkp-form-submit">
                    ...
                    <span class="mkp-form-submit-loading" style="display: none;"><?php esc_html_e( 'Sending...', 'mediakit-lite' ); ?></span>
                </button>
            </div>
        </form>
    </div>
...
function mkp_handle_contact_form_submission() {
    ...
    if ( ! isset( $_POST['mkp_contact_nonce'] ) || ! wp_verify_nonce( $_POST['mkp_contact_nonce'], $nonce_action ) ) {
        wp_send_json_error( __( 'Security check failed. Please refresh the page and try again.', 'mediakit-lite' ) );
    }
    
    // Check honeypot
    if ( ! empty( $_POST['mkp_website'] ) ) {
        wp_send_json_error( __( 'Spam detected.', 'mediakit-lite' ) );
    }
    ...
    foreach ( $required_fields as $field ) {
        if ( empty( $_POST[ $field ] ) ) {
            wp_send_json_error( __( 'Please fill in all required fields.', 'mediakit-lite' ) );
        }
    }
    ...
    if ( ! is_email( $form_data['email'] ) ) {
        wp_send_json_error( __( 'Please enter a valid email address.', 'mediakit-lite' ) );
    }
    ...
    if ( ! $submission_id ) {
        wp_send_json_error( __( 'Failed to save submission. Please try again.', 'mediakit-lite' ) );
    }
    ...
    if ( $email_sent ) {
        wp_send_json_success( array(
            'message' => __( 'Thank you for your message. We\'ll get back to you soon!', 'mediakit-lite' ),
        ) );
    } else {
        wp_send_json_error( __( 'Message received but email notification failed. We\'ll still get your message.', 'mediakit-lite' ) );
    }
}
...
function mkp_send_form_notification( $form_data, $submission_id ) {
    ...
    if ( $form_data['type'] === 'booking' ) {
        $subject = $subject_prefix . sprintf( __( 'Booking Request from %s', 'mediakit-lite' ), $form_data['name'] );
    } elseif ( $form_data['type'] === 'media' ) {
        $subject = $subject_prefix . sprintf( __( 'Media Inquiry from %s', 'mediakit-lite' ), $form_data['media_outlet'] );
    } else {
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            <h2 style="color: #2c3e50; border-bottom: 2px solid #3498db; padding-bottom: 10px;">
                <?php
                if ( $form_data['type'] === 'booking' ) {
                    esc_html_e( 'New Booking Request', 'mediakit-lite' );
                } elseif ( $form_data['type'] === 'media' ) {
                    esc_html_e( 'New Media Inquiry', 'mediakit-lite' );
                } else {
                    esc_html_e( 'New Contact Form Submission', 'mediakit-lite' );
                }
                ?>
            </h2>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Name:', 'mediakit-lite' ); ?></strong></td>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo esc_html( $form_data['name'] ); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Email:', 'mediakit-lite' ); ?></strong></td>
                ...
                <?php if ( $form_data['type'] === 'booking' ) : ?>
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Organization:', 'mediakit-lite' ); ?></strong></td>
                    ...
                    <?php if ( ! empty( $form_data['phone'] ) ) : ?>
                        <tr>
                            <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Phone:', 'mediakit-lite' ); ?></strong></td>
                            <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo esc_html( $form_data['phone'] ); ?></td>
                        </tr>
                    <?php endif; ?>
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Event Date:', 'mediakit-lite' ); ?></strong></td>
                    ...
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Event Type:', 'mediakit-lite' ); ?></strong></td>
                    ...
                    <?php if ( ! empty( $form_data['location'] ) ) : ?>
                        <tr>
                            <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Location:', 'mediakit-lite' ); ?></strong></td>
                ...
                <?php elseif ( $form_data['type'] === 'media' ) : ?>
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Media Outlet:', 'mediakit-lite' ); ?></strong></td>
                        <td style="padding: 10px; border-bottom: 1px solid #eee;"><?php echo esc_html( $form_data['media_outlet'] ); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Inquiry Type:', 'mediakit-lite' ); ?></strong></td>
                    ...
                    <?php if ( ! empty( $form_data['deadline'] ) ) : ?>
                        <tr>
                            <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Deadline:', 'mediakit-lite' ); ?></strong></td>
                ...
                <?php else : ?>
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #eee;"><strong><?php esc_html_e( 'Subject:', 'mediakit-lite' ); ?></strong></td>
            ...
            <div style="margin-top: 20px; padding: 15px; background-color: #f8f9fa; border-left: 4px solid #3498db;">
                <h3 style="margin-top: 0; color: #2c3e50;"><?php esc_html_e( 'Message:', 'mediakit-lite' ); ?></h3>
            ...
            <?php if ( current_user_can( 'manage_options' ) ) : ?>
                <div style="margin-top: 20px; padding: 10px; background-color: #e8f4fd; text-align: center;">
                    <a href="<?php echo esc_url( $admin_url ); ?>" style="display: inline-block; padding: 10px 20px; background-color: #3498db; color: white; text-decoration: none; border-radius: 4px;">
                        <?php esc_html_e( 'View in Dashboard', 'mediakit-lite' ); ?>
                    </a>
                </div>
            <?php endif; ?>
            
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; font-size: 12px; color: #666;">
                <p><?php printf( esc_html__( 'This message was sent from %s', 'mediakit-lite' ), esc_html( $site_name ) ); ?></p>
...
function mkp_send_form_confirmation( $form_data ) {
    $site_name = get_bloginfo( 'name' );
    $subject = sprintf( __( 'Thank you for contacting %s', 'mediakit-lite' ), $site_name );
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            <h2 style="color: #2c3e50;"><?php printf( esc_html__( 'Thank you, %s!', 'mediakit-lite' ), esc_html( $form_data['name'] ) ); ?></h2>
            
            <p><?php esc_html_e( 'We have received your message and will get back to you as soon as possible.', 'mediakit-lite' ); ?></p>
            
            <div style="margin: 20px 0; padding: 15px; background-color: #f8f9fa; border-left: 4px solid #3498db;">
                <h3 style="margin-top: 0;"><?php esc_html_e( 'Your Message:', 'mediakit-lite' ); ?></h3>
                <p><?php echo nl2br( esc_html( $form_data['message'] ) ); ?></p>
            </div>
            
            <?php if ( $form_data['type'] === 'booking' ) : ?>
                <p><?php esc_html_e( 'We typically respond to booking requests within 24-48 hours.', 'mediakit-lite' ); ?></p>
            <?php elseif ( $form_data['type'] === 'media' ) : ?>
                <p><?php esc_html_e( 'We understand the importance of media deadlines and will respond as quickly as possible.', 'mediakit-lite' ); ?></p>
            <?php endif; ?>
            
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; font-size: 12px; color: #666;">
                <p><?php esc_html_e( 'This is an automated confirmation. Please do not reply to this email.', 'mediakit-lite' ); ?></p>
            </div>
        </div>
    </body>
    </html>
