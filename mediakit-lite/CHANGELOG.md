...
### Changed
- Rework Open Graph to use Site Icon as primary social share image fallback
...
### Changed
- Fix hero mobile full-width image, reduce about section font size
...
### Changed
- Fix book and podcast card buttons to appear centered below Read more link

## [2.0.22] - 2026-03-13

### Changed
- Increase stats item width and reduce container padding for better spacing
